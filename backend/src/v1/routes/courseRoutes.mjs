...
router.delete('/:id/lesson/:lessonId', requireAuth, requireRoles(['admin', 'manager']), CourseController.removeLessonFromCourse)
router.put('/:id/lessons-order', requireAuth, requireRoles(['admin', 'manager']), CourseController.updateLessonsOrder)
